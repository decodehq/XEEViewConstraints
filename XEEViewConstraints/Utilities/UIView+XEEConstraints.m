...
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    return [self setViewRightToRightSideOf:self.superview withMargin:margin];
}

-(NSLayoutConstraint*) setViewAlignToSuperviewsLeftWithMargin:(CGFloat)margin
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    return [self setViewLeftToLeftSideOf:self.superview withMargin:margin];
}
...
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    return [self setViewBottomToBottomOf:self.superview withMargin:margin];
}

-(NSLayoutConstraint*) setViewAlignToSuperviewsTopWithMargin:(CGFloat)margin
{
    return [self setViewTopToTopOf:self.superview withMargin:margin];
}
